...
<div class="content_row row">
  ...
  <div class="col-md-7">
   ...
   <ul>
      <li>
      <p>
      What could be the possible reason Doug is not behaving normally and disturbing the class?
      </p>
      </li>
      <article>
      As the video says that Doug exhibits a variety of behaviours throughtout the day, and behaves excited sometimes, Doug could be emotionally disturbed student.
      <br>
      </article>
      <br/>
      ...
      <li>
      <p>
      What do you think the teacher should do in order to make Doug not to disturb the class.
      </p>
      </li>
      <article>
      ...
      <a class="mt-2 mt-md-0 btn btn-au-bdark my-2 my-sm-0" href="task6.php">Next Case</a>
      &nbsp;&nbsp;&nbsp;&nbsp;
