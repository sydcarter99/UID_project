...
<div class="content_row row">
  ...
  <div class="col-md-7 ">
   ...
   <ul>
      <li>
      <p>If you are in Ms. Smith's situation, what would you do?
      </p>
      </li>
      <p>
        ...
        Ignore Andy's talk and continue with the class.
         </label>
        </div>
        <div class="form-check">
          ...
          Ask Andy to stop talking about his weekend and continue with the class.
        </label>
        </div>
        <div class="form-check">
          ...
          Try deviating the topic into the topic to be covered in the class.
        </label>
        </div>
      </p>
      <br/>
      ...
      <li>
      <p>If the situation continues with Andy every week, what would you do?</p>
      </li>
      <p>
        <div class="form-check">
        ...
        <div class="form-check">
          ...
          After the class, talk to Andy and explain to him that he cannot speak every week.
          </label>
        </div>
        <div class="form-check">
          ...
          Make a particular student speak every week by calling the student's name.
          </label>
        </div>
      </p>
      </ul>
      ...
      <a class="mt-2 mt-md-0 btn btn-au-bdark my-2 my-sm-0" href="answer9.php">Check Answer</a>
      &nbsp;&nbsp;&nbsp;&nbsp;
