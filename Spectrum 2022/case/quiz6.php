...
<?
	...
	$pagetitle = "Lesson 6: Defiant Student";
...
<div class="content_row row">
  ...
  <!------- Main Content ------->
  <div class="col-md-7 ">
   <h2 class="section-header">Lesson 6: Defiant Student</h2>
   ...
   <ul>
      ...
      <p>
        ...
        <div class="form-check">
          ...
          Have the lab at a later date so you can explain to the students how to use critical thinking to solve a problem.
        </label>
        </div>
        <div class="form-check">
      ...
      <p>
        ...
        <div class="form-check">
          ...
          No, students are not able to understand critical thinking and apply it in real-world problems.
          </label>
        </div>
      </p>
      </ul>
